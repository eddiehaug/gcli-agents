...
<div align="center">
    <strong>The awesome collection of Gemini CLI subagents.</strong>
    <br />
    <br />
</div>
...
### As Gemini CLI Plugin (Recommended)
...
```bash
curl -s https://raw.githubusercontent.com/VoltAgent/awesome-claude-code-subagents/main/categories/09-meta-orchestration/agent-installer.md -o ~/.gemini/agents/agent-installer.md
```
...
Gemini CLI skill for browsing and fetching subagents from this catalog.
...
**Installation:**
```bash
cp -r tools/subagent-catalog ~/.gemini/commands/
```
